...
class FoundDogCreateMarker: AppRootViewController, TextFieldNextable {
    ...
    let privacyPicker = DefaultPicker(titleText: "Собака нашлась", isManySelectable: false)
    ...
    override func viewDidLoad() {
        ...
        privacyPicker.setupValues(values: ["Другая опасность", "Отрава", "Битое стекло", "Торчит арматура", "Змея", "Агрессивные бродячие собаки"])
...
extension FoundDogCreateMarker: UIScrollViewDelegate {
...
extension FoundDogCreateMarker: UITextViewDelegate {
