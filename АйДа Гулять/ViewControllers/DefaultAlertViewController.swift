...
class DefaultAlertViewController: UIViewController {
    ...
    let titleLabel = UILabel().then {
        $0.text = "Разрешить доступ к контактам?"
        $0.font = .montserratSemiBold(size: 22)
        $0.numberOfLines = 0
    }
    let descriptionLabel = UILabel().then {
        $0.text = "Если хочешь использовать режим прогулки, нужно поделиться своей геопозицией. Тогда в режиме прогулки тебя будут видеть на карте и ты сможешь видеть других"
