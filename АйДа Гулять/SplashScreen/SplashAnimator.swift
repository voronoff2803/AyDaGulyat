...
protocol SplashAnimatorDescription {
    ...
    func animateDisappearance(mainWindow: UIWindow, completion: (() -> ())?)
}
...
//        }
    ...
    func animateDisappearance(mainWindow: UIWindow, completion: (() -> ())?) {
        ...
        let maskImageView = UIImageView(image: UIImage.appImage(.logo))
...
//        }
    ...
    func addScalingAnimation(to layer: CALayer, duration: TimeInterval) {
        ...
        let finalScale = UIScreen.main.bounds.height / 20 + 10
