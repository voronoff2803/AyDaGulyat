//
//  KnowledgeDetailsCollectionCell.swift
//  АйДа Гулять
//
...
class KnowledgeDetailsCollectionCell: UICollectionViewCell {
    ...
    let titleLabel = Label().then {
        ...
        $0.text = "Способны ли собаки проявлять к другим собакам сочувствие"
    ...
    private func setupUI() {
        ...
        [imageView, titleLabel].forEach({self.contentView.addSubview($0)})
